...
public class Zone1 {
	public static final int INFINITY =  common.Common.INFINITY;
...
//						}
	...
	/*
	 * Return the minimal set of constraints from the DMB.
	 */
	public HashMap<Pair<LPNTran,LPNTran>, Integer> getMinConstr() {
		return this.dbm.getMinConstr(enabledSet);
	}
